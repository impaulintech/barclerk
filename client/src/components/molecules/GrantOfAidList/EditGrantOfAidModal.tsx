...
import { Plus, X, FilePlus, Calendar, Edit3, Minus } from 'react-feather'
...
const EditGrantOfAidModal: FC<Props> = ({ isOpen, closeModal, grant }): JSX.Element => {
  ...
  const {
    ...
    defaultValues: {
      ...
      date_effective: grant.date_effective
    }
  })
              ...
              <label htmlFor="date_effective" className="flex flex-col space-y-1">
                ...
                <div className="group relative">
                  ...
                  <input
                    ...
                    `}
                    defaultValue={grant.date_effective}
                  />
                </div>
              </label>
              {errors?.date_effective && (
